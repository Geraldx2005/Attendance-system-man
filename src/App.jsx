  ...
  return (
    ...
    ${activeView === "REPORTS"
        ...
        <button
          ...
          className="w-10 h-10 rounded-md flex items-center justify-center text-nero-400 hover:text-nero-100 hover:bg-nero-700 transition-colors cursor-pointer"
          title="Settings"
        >
          <IoSettingsSharp />
        </button>
